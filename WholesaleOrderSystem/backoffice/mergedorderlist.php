...
$basketIds="";
for($x = 0; $x < $_POST["orderCount"]; $x++)
{
    if(!empty($_POST["c".$x])){
        $basketIds=$basketIds."'".$_POST["c".$x]."',";        
    }

}
$basketIds=  substr($basketIds, 0,  strlen($basketIds)-1);
?>
<html lang="en">
...
$serviceConfig = parse_ini_file('../serviceConfig.ini');
                                            $service_url = $serviceConfig['serviceAddress'] . 'getGroupOrders/';
...
?>
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Merged Orders</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($rr["Orders"])) {
                                                for ($x = 0; $x < sizeof($rr["Orders"]); $x++) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $rr["Orders"][$x]["productname"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["phonemodelname"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["colorname"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["woodtypename"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["orderCount"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["totalCount"]; ?></td>
                                                    </tr>
                                                <?php }
                                                ?>
                                                <tr>
