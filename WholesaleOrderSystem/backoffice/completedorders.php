    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Completed Order List</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $service_url = $serviceConfig['serviceAddress'] . 'getCompletedOrders/';
                                            ...
                                            if (!empty($rr["Orders"])) {
                                                for ($x = 0; $x < sizeof($rr["Orders"]); $x++) {
                                                    ...
                                                    ?>
                                                    <tr onclick="directDetail('<?php echo $rr["Orders"][$x]["id"]; ?>')">
                                                        <td><?php echo $x + 1; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["namesurname"]; ?></td>
                                                        <td><?php echo $rr["Orders"][$x]["endDate"]; ?></td>
