    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Waiting Merchants</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $service_url = $serviceConfig['serviceAddress'] . 'getWaitingMerchants/';
                                            ...
                                            if (!empty($rr["Merchants"])) {
                                                for ($x = 0; $x < sizeof($rr["Merchants"]); $x++) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="approvemerchant.php?id=<?php echo $rr["Merchants"][$x]["id"]; ?>">Approve</a></td>
