    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <!-- /.row -->
                <form role="form" method="POST" action="deleteBatchModelService.php" onsubmit="disableAll()">
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <button type="submit" class="btn btn-default" name="add" id="add">Delete all</button>
