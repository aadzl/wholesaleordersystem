...
<html lang="en">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Product List - <a href="productNew.php">Add New</a></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-9">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Products - <a href="addBatchModel.php">Add Batch Processing</a> - <a href="deleteBatchModel.php">Delete Batch Processing</a>
                            </div>
                            <!-- /.panel-heading -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th><a href="products.php?orderBy=pname">Name</a></th>
                                                <th><a href="products.php">Process Date</a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            if (!empty($rr["Product"])) {
                                                for ($x = 0; $x < sizeof($rr["Product"]); $x++) {
                                                    ?>
                                                    <tr onclick="directDetail('<?php echo $rr["Product"][$x]["id"]; ?>')">
                                                        <td><?php echo substr($rr["Product"][$x]["id"], 1, 5) . "..."; ?></td>
                                                        <td><?php echo $rr["Product"][$x]["name"]; ?></td>
                                                        <td><?php echo $rr["Product"][$x]["processDate"]; ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
    ...
    <script>
                                                        function directDetail(id) {
                                                            document.location.href = 'productDetail.php?id=' + id;
                                                        }
    </script>
</html>
